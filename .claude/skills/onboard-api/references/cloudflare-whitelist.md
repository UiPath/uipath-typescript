...
7. **If tests pass**, create branch, commit, push, and raise PR:
   ...
   - PR body: mention this is for the SDK onboarding PR being raised in Step 4
...
- **If tests fail**, stop this step and show the error but continue with Step 4 for the SDK PR.
