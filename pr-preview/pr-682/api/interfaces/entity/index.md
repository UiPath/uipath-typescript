...
- `options?`: `EntityGetByNameOptions` — Optional [EntityGetByNameOptions](../EntityGetByNameOptions/) (e.g. `folderKey` for folder-scoped entities) The `folderKey` property is **experimental**.
