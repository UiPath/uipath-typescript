...
Each IDE expects skills in a different directory. Copy the skills into the correct location for your IDE:

#### Claude Code

```bash
cp -r uipath-typescript/agent-skills/.agent/skills/* /path/to/your-project/.claude/skills/
```

Skills are auto-discovered from `.claude/skills/` and available as slash commands (e.g., `/create-app`). You can also install them globally at `~/.claude/skills/`.
...
```bash
cp -r uipath-typescript/agent-skills/.agent/skills/* /path/to/your-project/.cursor/skills/
```
...
```bash
cp -r uipath-typescript/agent-skills/.agent/skills/* /path/to/your-project/.agents/skills/
```
...
```bash
cp -r uipath-typescript/agent-skills/.agent/skills/* /path/to/your-project/.agent/skills/
```
...
```bash
cp -r uipath-typescript/agent-skills/.agent/skills/* /path/to/your-project/.windsurf/skills/
```
...
### create-app — Create a New Coded App
...
### debug-app — Debug Authentication & Configuration Issues
...
### deploy-app — Deploy to UiPath Cloud
...
Pull the latest changes and re-copy the skills into your IDE's directory:
...
Then re-run the `cp` command for your IDE from the installation steps above.

## Uninstalling

Remove the skill directories from your project:
