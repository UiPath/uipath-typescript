 ...
 *
 * Note: This is a copy of the schema from the CLI package to avoid
 * cross-package TypeScript imports. Keep in sync with:
 * packages/cli/src/generator/config.schema.ts
 */
