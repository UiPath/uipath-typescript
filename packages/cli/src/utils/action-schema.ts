...
function mapJsonTypeToSystemType(type: JsonDataType, format?: JsonFormatType): VBDataType {
  ...
  switch (type) {
    case JsonDataType.string:
      return VBDataType.string;
    case JsonDataType.integer:
      return VBDataType.int64;
    case JsonDataType.number:
      return VBDataType.decimal;
    case JsonDataType.boolean:
      return VBDataType.boolean;
    case JsonDataType.object:
      return VBDataType.object;
    case JsonDataType.file:
      return VBDataType.iresource;
    default:
...
function transformProperty(name: string, propDef: JsonSchemaProperty): ParsedActionPropertySchema {
  ...
  if (propDef.type === JsonDataType.object && propDef.properties) {
    ...
    propDef.type === JsonDataType.array &&
    propDef.items &&
    propDef.items.type === JsonDataType.object &&
