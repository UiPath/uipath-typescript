/**
 * Auto-generated CLI Command: assets list
 *
...
export default class List extends Command {
  static description = "List all Orchestrator assets with optional filtering";
  ...
  async run(): Promise<void> {
    ...
    const spinner = ora('Executing assets list...').start();

    try {
      const client = await getSDKClient();
      const result = await client.assets.getAll(flags as any);
