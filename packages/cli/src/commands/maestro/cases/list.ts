/**
 * Auto-generated CLI Command: maestro cases list
 *
...
export default class List extends Command {
  static description = "Get all case management processes with their instance statistics";

  static examples = [
    'uipath maestro cases list'
  ];
  ...
  @track('maestro cases.list')
  async run(): Promise<void> {
    const { flags } = await this.parse(List);
    const spinner = ora('Executing maestro cases list...').start();
