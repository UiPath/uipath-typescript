/**
 * Auto-generated CLI Command: buckets list
 *
...
export default class List extends Command {
  static description = "Gets all buckets across folders with optional filtering and folder scoping\n\nThe method returns either:\n- An array of buckets (when no pagination parameters are provided)\n- A paginated result with navigation cursors (when any pagination parameter is provided)";
  ...
  async run(): Promise<void> {
    ...
    const spinner = ora('Executing buckets list...').start();

    try {
      const client = await getSDKClient();
      const result = await client.buckets.getAll(flags as any);
