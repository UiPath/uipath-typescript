/**
 * Auto-generated CLI Command: entities list
 *
...
export default class List extends Command {
  static description = "Gets all entities in the system";

  static examples = [
    'uipath entities list'
  ];
  ...
  async run(): Promise<void> {
    ...
    const spinner = ora('Executing entities list...').start();
