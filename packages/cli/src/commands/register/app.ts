...
import { EnvironmentConfig, AppConfig, AppTypes, ActionSchemaConstants } from '../../types/index.js';
...
import { readAndParseActionSchema } from '../../utils/action-schema-utils.js';
...
export default class RegisterApp extends Command {
  ...
  static override flags = {
    ...
    type: Flags.string({
      ...
      default: AppTypes.Web,
      options: [AppTypes.Web, AppTypes.Action]
    })
  };
  ...
  public async run(): Promise<void> {
    ...
    const isActionApp = flags.type as AppTypes === AppTypes.Action;
  ...
  private async publishAppToUiPath(packageName: string, packageVersion: string, isActionApp: boolean, envConfig: EnvironmentConfig): Promise<RegisterResponse> {
    ...
    const payload = {
      ...
      title: packageName,
      schema: isActionApp ? readAndParseActionSchema() : {},
    };
