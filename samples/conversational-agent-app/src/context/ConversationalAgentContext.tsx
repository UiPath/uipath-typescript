...
export function ConversationalAgentProvider({ children }: { children: ReactNode }) {
  ...
  const selectConversation = useCallback(
    async (conversation: ConversationGetResponse) => {
  ...
  return <ConversationalAgentContext.Provider value={value}>{children}</ConversationalAgentContext.Provider>;
}
