      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8">
        <div className="text-center mb-8">
          <div className="flex justify-center mb-4">
            <div className="bg-orange-500 text-white px-3 py-2 rounded text-lg font-bold">
              USI
            </div>
          </div>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Case Management</h1>
          <p className="text-gray-600">U Market Dashboard</p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <button
            onClick={handleLogin}
            disabled={isLoading}
            className="w-full bg-[#0a2540] hover:bg-[#1a3550] disabled:bg-gray-400 text-white font-medium py-3 px-4 rounded-lg transition-colors flex items-center justify-center"
          >
            {isLoading ? (
              <>
