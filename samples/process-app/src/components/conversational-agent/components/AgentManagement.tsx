...
import type { AgentStartingPrompt } from '@uipath/uipath-typescript/conversational-agent';
              ...
              {agentAppearance.appearance.startingPrompts && agentAppearance.appearance.startingPrompts.length > 0 && (
                <div className="mt-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {agentAppearance.appearance.startingPrompts.map((prompt: AgentStartingPrompt) => (
                      <button
                        key={prompt.id}
