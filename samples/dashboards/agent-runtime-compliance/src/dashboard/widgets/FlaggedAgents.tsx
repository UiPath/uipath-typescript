...
const KPI_DETAIL_ROUTE = '/flaggedagents'
...
export function FlaggedAgents({ range = '30d' }: { range?: RangeKey }) {
  ...
  return (
    <WidgetBoundary label="Flagged Agents">
      <Card
      ...
      >
        <CardHeader className="flex flex-row items-start justify-between gap-3 space-y-0">
          <div className="min-w-0">
            ...
            <CardDescription>Agents with at least one failed check — {RANGE_LABELS[range]}</CardDescription>
          </div>
