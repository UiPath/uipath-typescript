...
const KPI_DETAIL_ROUTE = '/policieswithviolations'
...
function usePoliciesWithViolationsData(range: RangeKey) {
...
export function PoliciesWithViolations({ range = '30d' }: { range?: RangeKey }) {
  ...
  const { data, loading, error } = usePoliciesWithViolationsData(range)
