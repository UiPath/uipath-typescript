...
// The whole package, `fonts.css` and its 40+ MB of fonts included: the app renders in an
// iframe, which inherits no `@font-face` rules from the page around it, so dropping them
// leaves the widget's icons blank.
