      ...
      <div className="flex items-center justify-center h-full text-center">
        <div className="max-w-md mx-auto p-8">
          ...
          <p className="text-gray-500 leading-relaxed">
            Select a process instance from the left panel to view detailed information, execution data, and attached
            files.
          </p>
        </div>
      </div>
      ...
      <div className="h-full overflow-y-auto">
        ...
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-blue-100 p-4">
          <div className="flex items-start justify-between">
            ...
            <span
              className={`px-4 py-2 text-sm font-semibold rounded-full shadow-sm ${getStatusColor(selectedInstance.latestRunStatus || 'unknown')}`}
            >
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                <span className="text-sm text-gray-600">
                  ...
                  at{' '}
                  {new Date(selectedInstance.startedTime).toLocaleTimeString([], {
                    hour: '2-digit',
                    minute: '2-digit',
                  })}
                </span>
              ...
              {selectedInstance.completedTime && (
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-sm text-gray-600">
                    ...
                    at{' '}
                    {new Date(selectedInstance.completedTime).toLocaleTimeString([], {
                      hour: '2-digit',
                      minute: '2-digit',
                    })}
                  </span>
                  ...
                  <div className="p-2 bg-purple-100 rounded-lg">
                    <svg className="w-6 h-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth={2}
                        d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v1.586a1 1 0 00.293.707l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2h-5.586a1 1 0 01-.707-.293L7.707 21.707A1 1 0 017 21z"
                      />
                    </svg>
                  </div>
                  Variables
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-xl w-[90vw] h-[90vh] flex flex-col">
            <div className="flex justify-between items-center p-4 border-b">
              ...
              <button onClick={() => setIsTaskPopupOpen(false)} className="text-gray-400 hover:text-gray-500">
