...
<script type="application/json" id="tg-data">
{
  ...
  "apps": [
    ...
    { "id": "action-app-with-functions", "title": "Action App — Coded Functions", "description": "Coded Action App for credential verification. A coded function resolves an Orchestrator Credential or Secret asset as a robot and returns it to the app — the only route to a value the Assets API never exposes to the browser.", "category": "action-apps", "framework": "React", "tags": ["Action Center","Coded Action App","Coded Functions","Orchestrator","Assets"], "path": "samples/coded-action-apps/action-app-with-functions", "preview": null },
