...
<script type="application/json" id="tg-data">
{
  ...
  "categories": [
    ...
    { "id": "connections", "label": "Connections", "accent": ["#00796B", "#26A69A"] },
  ...
  "apps": [
    ...
    { "id": "connections-app", "title": "Connections Explorer", "description": "Browse UiPath connectors, inspect their connections and activities, and run an activity against a live connection. Input forms are generated from connector metadata, with the matching execute() snippet shown as you type.", "category": "connections", "framework": "React", "tags": ["Connections","Connectors","Coded App"], "path": "samples/connections-app", "preview": "samples/connections-app/screenshots/preview.gif" },
    ...
    { "id": "action-app-with-file-attachment-document", "title": "Action App — File Attachment", "description": "Coded Action App for loan-application review with direct file attachments. Preview and download a directly attached PDF as opposed to referencing files from Storage Buckets, and upload a supporting document that is bound to the job behind the action.", "category": "action-apps", "framework": "React", "tags": ["Action Center","Coded Action App","File Attachments","Uploads","Job Attachments","Documents"], "path": "samples/coded-action-apps/action-app-with-file-attachment-document", "preview": "samples/coded-action-apps/action-app-with-file-attachment-document/screenshots/preview.gif" },
