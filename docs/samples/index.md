...
<script type="application/json" id="tg-data">
{
  ...
  "categories": [
    ...
    { "id": "functions", "label": "Coded Functions", "accent": ["#B45309", "#F59E0B"] },
  ...
  "apps": [
    ...
    { "id": "document-validation-app", "title": "Document Validation Inbox", "description": "A human-in-the-loop document validation inbox on top of UiPath Action Center. Lists validation tasks grouped into Pending / Unassigned / Completed, renders the validation station, and lets a reviewer save or submit the task", "category": "document", "framework": "React", "tags": ["Document Understanding","Action Center","HITL","OAuth / PKCE"], "path": "samples/document-validation-app", "preview": "samples/document-validation-app/screenshots/preview.gif" },
    { "id": "document-validation-subcomponents-app", "title": "Document Review Workspace", "description": "The same human-in-the-loop review, composed from the validation station's five subcomponents instead of the all-in-one widget \u2014 document viewer, document type, extraction fields, line-item editor and business rules, laid out in a custom grid and linked by one shared instanceId.", "category": "document", "framework": "React", "tags": ["Document Understanding","Action Center","HITL","Subcomponents","OAuth / PKCE"], "path": "samples/document-validation-subcomponents-app", "preview": "samples/document-validation-subcomponents-app/screenshots/preview.gif" },
    { "id": "functions-app", "title": "Coded Functions: Promo Shop", "description": "Invoke UiPath Coded Functions with typed input and output. A small shop whose discount codes live in an Orchestrator Secret asset, unreadable from the browser, so validating a code has to happen inside a function.", "category": "functions", "framework": "React", "tags": ["Coded Functions","Secret Assets","Coded App"], "path": "samples/functions-app", "preview": "samples/functions-app/screenshots/preview.gif" },
    { "id": "secrets", "title": "Coded Functions: Partner Credential", "description": "A Coded App and its functions shipped as one solution. Reading an Orchestrator Credential asset happens inside a function under its own robot identity, so only a username, a length and a fingerprint reach the browser — never the secret.", "category": "functions", "framework": "React", "tags": ["Coded Functions","Credential Assets","Solutions","Coded App"], "path": "samples/coded-apps-with-functions/secrets", "preview": "samples/coded-apps-with-functions/secrets/screenshots/preview.jpg" },
    { "id": "rest-backend", "title": "Coded Functions: REST Invoice API", "description": "Three functions shaped as REST resources — a collection, an item, and a nested sub-resource — showing path params versus query filters, specificity-based routing, and 404s that name the ids that would have worked.", "category": "functions", "framework": "React", "tags": ["Coded Functions","REST","Routing","Coded App"], "path": "samples/coded-apps-with-functions/rest-backend", "preview": "samples/coded-apps-with-functions/rest-backend/screenshots/collection-filter.jpg" },
    { "id": "calling-mode", "title": "Coded Functions: Calling Mode", "description": "Two functions with identical handlers — one declares method and path, the other declares neither. That single difference decides whether you get a URL to call or a job to start, and whether a megabyte can get through at all.", "category": "functions", "framework": "React", "tags": ["Coded Functions","Jobs","Attachments","Coded App"], "path": "samples/coded-apps-with-functions/calling-mode", "preview": "samples/coded-apps-with-functions/calling-mode/screenshots/preview.jpg" },
    ...
    { "id": "queues-app", "title": "Queue Explorer", "description": "Browse UiPath Orchestrator queues across folders, inspect and insert queue items, and run the transaction lifecycle — start a transaction and complete it with output data or failure details.", "category": "process", "framework": "React", "tags": ["Orchestrator","Queues","Transactions","Coded App"], "path": "samples/queues-app", "preview": "samples/queues-app/screenshots/preview.gif" },
    { "id": "action-app-with-data-fabric-entity", "title": "Action App — Data Fabric Entity", "description": "Coded Action App for loan-application review backed by a Data Fabric entity. Fetch an applicant record by name, review details, view the bundled document, and write the decision back to the entity.", "category": "action-apps", "framework": "React", "tags": ["Action Center","Coded Action App","Data Fabric","File Attachments"], "path": "samples/coded-action-apps/action-app-with-data-fabric-entity", "preview": "samples/coded-action-apps/action-app-with-data-fabric-entity/screenshots/preview.gif" },
    { "id": "action-app-with-document", "title": "Action App — Bundled Document", "description": "Coded Action App for loan-application review. Reviewers assess applicant details, view a bundled sample PDF, and complete the task with an Approve or Reject decision.", "category": "action-apps", "framework": "React", "tags": ["Action Center","Coded Action App","Documents"], "path": "samples/coded-action-apps/action-app-with-document", "preview": "samples/coded-action-apps/action-app-with-document/screenshots/preview.gif" },
    { "id": "action-app-with-file-attachment-document", "title": "Action App — File Attachment", "description": "Coded Action App for loan-application review with direct file attachments. Preview and download a directly attached PDF, as opposed to referencing files from Storage Buckets.", "category": "action-apps", "framework": "React", "tags": ["Action Center","Coded Action App","File Attachments","Documents"], "path": "samples/coded-action-apps/action-app-with-file-attachment-document", "preview": "samples/coded-action-apps/action-app-with-file-attachment-document/screenshots/preview.gif" },
    ...
    { "id": "action-app-with-document-validation-subcomponents", "title": "Action App \u2014 Document Validation (Subcomponents)", "description": "Coded Action App that composes the Document Understanding Validation Station from its five subcomponents into a custom grid \u2014 document viewer, document type, extraction fields, line-item editor and business rules, linked by one shared instanceId.", "category": "action-apps", "framework": "React", "tags": ["Action Center","Coded Action App","Document Understanding","Validation Station","Subcomponents","HITL"], "path": "samples/coded-action-apps/action-app-with-document-validation-subcomponents", "preview": "samples/coded-action-apps/action-app-with-document-validation-subcomponents/screenshots/preview.gif" }
  ]
}
</script>
