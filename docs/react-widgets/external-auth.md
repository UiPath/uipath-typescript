...
!!! info "This widget takes no SDK instance"
    External Auth never calls UiPath. It is for signing users into your own app through a third-party identity provider. To authenticate against UiPath itself, see [Authentication](../authentication.md).
