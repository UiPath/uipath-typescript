...
!!! tip "Finding the entity ID"
    `entityId` is the UUID of a Data Fabric entity. List the ones available to you with the Entities service — see the [Entity service reference](../api/interfaces/entity/index.md):
