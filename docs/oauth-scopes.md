...
| `getGovernanceChecks()` | `Insights.RealTimeData Insights OR.Folders.Read` (caller must be an org admin) |
| `getGovernanceSummary()` | `Insights.RealTimeData Insights OR.Folders.Read` (caller must be an org admin) |
