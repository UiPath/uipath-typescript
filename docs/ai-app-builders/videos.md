...
<div class="vg">
  ...
  <a class="vg-card" href="../lovable/#watch-the-walkthrough">
    ...
    <span class="vg-body">
      ...
      <span class="vg-desc">Prompt to live app with no local setup. Secrets live in Lovable Cloud, and the build sandbox runs the deploy.</span>
  ...
  <a class="vg-card" href="../replit/#watch-the-walkthrough">
    ...
    <span class="vg-body">
      ...
      <span class="vg-desc">A full browser IDE, so you can watch the code as it is written. Replit Secrets are readable from the shell the deploy runs in.</span>
      <span class="vg-cta">Watch and read the guide</span>
    </span>
  </a>
  ...
  <a class="vg-card" href="../vercel/#watch-the-walkthrough">
    ...
    <span class="vg-body">
      ...
      <span class="vg-desc">The skill comes straight from v0's marketplace. Credentials stay in encrypted environment variables and never reach the client bundle.</span>
      <span class="vg-cta">Watch and read the guide</span>
    </span>
  </a>
  ...
  <a class="vg-card" href="../bolt/#watch-the-walkthrough">
    ...
    <span class="vg-body">
      ...
      <span class="vg-desc">Everything runs in an in-browser WebContainer. Credentials go in a project <code>.env</code>, since Bolt's managed secrets are not exposed to its shell.</span>
      <span class="vg-cta">Watch and read the guide</span>
    </span>
  </a>
