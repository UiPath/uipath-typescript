...
export const EXCHANGE_ENDPOINTS = {
  LIST: (conversationId: string) => `${AUTOPILOT_BASE}/api/${API_VERSION}/conversation/${conversationId}/exchange`,
...
export const ATTACHMENT_ENDPOINTS = {
  CREATE: (conversationId: string) => `${AUTOPILOT_BASE}/api/${API_VERSION}/conversation/${conversationId}/attachment`,
} as const;
