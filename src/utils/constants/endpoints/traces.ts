...
export const TRACES_ENDPOINTS = {
  ...
  /** POST specific spans by ID. traceId in query, spanIds array in body */
  POST_BY_IDS: (traceId: string) =>
    `${LLMOPS_BASE}/api/Traces/v2/spans/otel/byIds?traceId=${encodeURIComponent(traceId)}`,
