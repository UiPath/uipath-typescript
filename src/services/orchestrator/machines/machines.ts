...
import { MachineMap } from '../../../models/orchestrator/machines.constants';
...
export class MachineService extends BaseService implements MachineServiceModel {
  ...
  > {
    ...
    return PaginationHelpers.getAll({
      ...
      getByFolderEndpoint: MACHINE_ENDPOINTS.GET_ALL,
  ...
  async getById(id: number, options: MachineGetByIdOptions = {}): Promise<MachineGetResponse> {
    ...
    return transformData(pascalToCamelCaseKeys(response.data) as MachineGetResponse, MachineMap);
  }
}
