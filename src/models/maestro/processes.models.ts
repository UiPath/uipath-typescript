...
export interface MaestroProcessesServiceModel {
   ...
   * {@link MaestroProcessGetResponse}
   * @example
   * ```typescript
   * // Get all processes
...
export interface ProcessMethods {
  /**
   * Gets incidents for this process with BPMN enrichment
   * 
   * @returns Promise resolving to array of incidents for this process with BPMN-enriched fields
   */
