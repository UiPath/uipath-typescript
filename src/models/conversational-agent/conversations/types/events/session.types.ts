...
import type { AsyncToolCallStream } from './tool-call.types';
...
export interface SessionStream {
   ...
   * @internal
   */
  startAsyncToolCall(args: { toolCallId?: string } & ToolCallStartEvent): AsyncToolCallStream;
   ...
   * @internal
   */
  startAsyncInputStream(args: { streamId?: string } & AsyncInputStreamStartEvent): AsyncInputStream;
   ...
   * @internal
   */
  onAnyErrorStart(cb: (errorStart: { source: unknown; errorId: string } & ErrorStartEvent) => void): () => void;
   ...
   * @internal
   */
  onAnyErrorEnd(cb: (errorEnd: { source: unknown; errorId: string } & ErrorEndEvent) => void): () => void;
