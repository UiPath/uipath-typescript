...
> **getById**(`id`: `number`, `folderId`: `number`, `options?`: [`QueueGetByIdOptions`](../QueueGetByIdOptions/)): `Promise`\<[`QueueGetResponse`](../QueueGetResponse/)>
...
| `options?` | [`QueueGetByIdOptions`](../QueueGetByIdOptions/) | -                  |
