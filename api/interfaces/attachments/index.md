...
> **getById**(`id`: `string`, `options?`: [`AttachmentGetByIdOptions`](../AttachmentGetByIdOptions/)): `Promise`\<[`AttachmentResponse`](../AttachmentResponse/)>
...
| `options?` | [`AttachmentGetByIdOptions`](../AttachmentGetByIdOptions/) | Optional query parameters (expand, select) |
