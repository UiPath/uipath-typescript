...
`Promise`\<[`EntityGetResponse`](../type-aliases/EntityGetResponse.md)[]>

Promise resolving to either an array of entities NonPaginatedResponse or a PaginatedResponse when pagination options are used. [EntityGetResponse](../type-aliases/EntityGetResponse.md)
...
Promise resolving to entity metadata with operation methods [EntityGetResponse](../type-aliases/EntityGetResponse.md)
...
| --------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| `T` *extends* [`EntityGetRecordsByIdOptions`](../type-aliases/EntityGetRecordsByIdOptions.md) | [`EntityGetRecordsByIdOptions`](../type-aliases/EntityGetRecordsByIdOptions.md) |
...
`Promise`\<`T` *extends* [`HasPaginationOptions`](../type-aliases/HasPaginationOptions.md)\<`T`> ? [`PaginatedResponse`](PaginatedResponse.md)\<[`EntityRecord`](EntityRecord.md)> : [`NonPaginatedResponse`](NonPaginatedResponse.md)\<[`EntityRecord`](EntityRecord.md)>>

Promise resolving to either an array of entity records NonPaginatedResponse or a PaginatedResponse when pagination options are used. [EntityRecord](EntityRecord.md)
...
getRecordById(
   entityId: string, 
   recordId: string, 
   options?: EntityGetRecordByIdOptions): Promise<EntityRecord>;
```
...
| `options?` | [`EntityGetRecordByIdOptions`](EntityGetRecordByIdOptions.md) | Query options      |

#### Returns

`Promise`\<[`EntityRecord`](EntityRecord.md)>

Promise resolving to a single entity record [EntityRecord](EntityRecord.md)
...
insertRecordById(
   ...
   options?: EntityInsertOptions): Promise<EntityRecord>;
```
...
| `options?` | [`EntityInsertOptions`](EntityInsertOptions.md) | Insert options     |

#### Returns

`Promise`\<[`EntityRecord`](EntityRecord.md)>

Promise resolving to the inserted record with generated record ID [EntityInsertResponse](../type-aliases/EntityInsertResponse.md)
...
| `options?` | [`EntityOperationOptions`](EntityOperationOptions.md) | Insert options             |

#### Returns

`Promise`\<[`EntityOperationResponse`](EntityOperationResponse.md)>

Promise resolving to insert response [EntityBatchInsertResponse](../type-aliases/EntityBatchInsertResponse.md)
...
| ---------- | ----------------------------------------------------- | ------------------------------------------------------------------- |
| `id`       | `string`                                              | UUID of the entity                                                  |
| `data`     | [`EntityRecord`](EntityRecord.md)[]                   | Array of records to update. Each record MUST contain the record Id. |
| `options?` | [`EntityOperationOptions`](EntityOperationOptions.md) | Update options                                                      |

#### Returns

`Promise`\<[`EntityOperationResponse`](EntityOperationResponse.md)>

Promise resolving to update response [EntityUpdateResponse](../type-aliases/EntityUpdateResponse.md)
...
| `options?`  | [`EntityDeleteOptions`](EntityDeleteOptions.md) | Delete options                  |

#### Returns

`Promise`\<[`EntityOperationResponse`](EntityOperationResponse.md)>

Promise resolving to delete response [EntityDeleteResponse](../type-aliases/EntityDeleteResponse.md)
...
| Parameter | Type                                                                    | Description                                            |
| --------- | ----------------------------------------------------------------------- | ------------------------------------------------------ |
| `options` | [`EntityDownloadAttachmentOptions`](EntityDownloadAttachmentOptions.md) | Options containing entityName, recordId, and fieldName |
