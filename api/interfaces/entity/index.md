...
> **uploadAttachment**(`options`: [`EntityUploadAttachmentOptions`](../EntityUploadAttachmentOptions/)): `Promise`\<[`EntityUploadAttachmentResponse`](../../type-aliases/EntityUploadAttachmentResponse/)>
...
| Parameter | Type                                                                 | Description                                                                           |
| --------- | -------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| `options` | [`EntityUploadAttachmentOptions`](../EntityUploadAttachmentOptions/) | Options containing entityName, recordId, fieldName, file, and optional expansionLevel |

#### Returns

`Promise`\<[`EntityUploadAttachmentResponse`](../../type-aliases/EntityUploadAttachmentResponse/)>

Promise resolving to the upload response [EntityUploadAttachmentResponse](../../type-aliases/EntityUploadAttachmentResponse/)
