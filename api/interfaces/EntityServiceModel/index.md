...
Note: Data Fabric supports trigger events only on individual inserts, not on batch inserts. Use this method if you need trigger events to fire for the inserted record.
...
Note: Batch inserts do not trigger Data Fabric trigger events. Use [insertById](#insertbyid) if you need trigger events to fire for each inserted record.
