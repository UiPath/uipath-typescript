import { FeedbackCategory, FeedbackGetResponse, FeedbackStatus } from '../../../src/models/agents/feedback/feedback.types';
 ...
 */
export const createMockFeedback = (overrides: Partial<FeedbackGetResponse> = {}): FeedbackGetResponse => ({
