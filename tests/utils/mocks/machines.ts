 ...
 */
import { MachineGetResponse, MachineScope, MachineType } from '../../../src/models/orchestrator/machines.types';
import { PaginationCursor } from '../../../src/utils/pagination';
...
export const createMockRawMachine = (overrides: Partial<any> = {}): any => {
  return createMockBaseResponse({
    ...
    LicenseKey: MACHINE_TEST_CONSTANTS.LICENSE_KEY,
  }, overrides);
};
