...
export const createMockChoiceSetValueResponse = (overrides: Partial<any> = {}): any => {
  return {
    ...
    CreatedBy: CHOICESET_TEST_CONSTANTS.VALUE_CREATED_BY,
    UpdatedBy: CHOICESET_TEST_CONSTANTS.VALUE_UPDATED_BY,
    RecordOwner: CHOICESET_TEST_CONSTANTS.VALUE_RECORD_OWNER,
    ...overrides
  };
};
