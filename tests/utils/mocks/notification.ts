...
import type {
  ...
  SubscriptionPublisherBase,
  SubscriptionTopic,
  SubscriptionTopicBase,
  SupportedChannel,
...
export const createBasicSubscriptionPublisher = (
  ...
  entityTypes: null,
  topicGroupEntities: [],
  topicGroupEntityTypes: null,
  topics: [createBasicSubscriptionTopic()],
  ...overrides,
});

/**
 * Builds a discovery-only topic (as returned by `getPublishers()`) — identity fields only.
 */
export const createBasicSubscriptionTopicBase = (
  overrides?: Partial<SubscriptionTopicBase>
): SubscriptionTopicBase => ({
  id: NOTIFICATION_TEST_CONSTANTS.TOPIC_ID,
  name: NOTIFICATION_TEST_CONSTANTS.TOPIC_NAME,
  displayName: NOTIFICATION_TEST_CONSTANTS.TOPIC_DISPLAY_NAME,
...
/**
 * Builds a discovery-only publisher (as returned by `getPublishers()`) — identity fields
 * plus the topic catalogue, no subscription state.
 */
export const createBasicSubscriptionPublisherBase = (
  overrides?: Partial<SubscriptionPublisherBase>
): SubscriptionPublisherBase => ({
  id: NOTIFICATION_TEST_CONSTANTS.PUBLISHER_ID,
  name: NOTIFICATION_TEST_CONSTANTS.PUBLISHER_NAME,
  displayName: NOTIFICATION_TEST_CONSTANTS.PUBLISHER_DISPLAY_NAME,
  topics: [createBasicSubscriptionTopicBase()],
  ...overrides,
});
