...
export const ENTITY_TEST_CONSTANTS = {
  ...
  FIELD_ID_CATEGORY: 'f4234567-e89b-12d3-a456-426614174003',
  ...
  REFERENCE_TARGET_FOLDER_KEY: 'c1234567-e89b-12d3-a456-426614174000',
  CHOICE_SET_TARGET_ID: 'd1234567-e89b-12d3-a456-426614174000',
  ...
  FIELD_TYPE_NVARCHAR: 'NVARCHAR', // SQL type (raw, pre-transform)
