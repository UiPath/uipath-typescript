...
function validateConfig(rawConfig: Record<string, unknown>): IntegrationConfig {
  ...
  return {
    ...
    insightsRtmTenantId: typeof rawConfig.insightsRtmTenantId === 'string' ? rawConfig.insightsRtmTenantId : undefined,
  };
}
...
export function loadIntegrationConfig(): IntegrationConfig {
  ...
  const rawConfig = {
    ...
    insightsRtmTenantId: process.env.INSIGHTS_RTM_TENANT_ID || undefined,
  };
