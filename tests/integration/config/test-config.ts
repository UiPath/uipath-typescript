...
export interface IntegrationConfig {
  ...
  // Cross-entity join fixture for the queryRecordsById join tests. The three
  // join-key fields are required (the tests throw when any is missing);
  // dataFabricTestJoinEntityName names the join's base entity and falls back to
  // the queried entity's own name when unset.
