...
// ===== TEST SUITE =====
describe('MaestroProcessesService - getInstanceStatusByDate', () => {
  ...
  it('should send undefined timeSliceUnit when options omitted', async () => {
  ...
  it('should always send isCaseManagement as false', async () => {
    mockApiClient.post.mockResolvedValue([]);
