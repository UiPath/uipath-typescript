...
describe('ProcessInstancesService', () => {
  ...
  describe('getById', () => {
    ...
    it('should handle API errors', async () => {
      ...
      await expect(
        service.getById(MAESTRO_TEST_CONSTANTS.INSTANCE_ID, MAESTRO_TEST_CONSTANTS.FOLDER_KEY),
  ...
  describe('getExecutionHistory', () => {
    it('should return execution history for process instance', async () => {
      ...
      expect(mockApiClient.get).toHaveBeenCalledWith(MAESTRO_ENDPOINTS.INSTANCES.GET_EXECUTION_HISTORY(instanceId), {});
    ...
    it('should handle API errors', async () => {
      ...
      await expect(service.getExecutionHistory(MAESTRO_TEST_CONSTANTS.INSTANCE_ID)).rejects.toThrow(
  ...
  describe('getBpmn', () => {
    it('should return BPMN XML for process instance', async () => {
      ...
      expect(mockApiClient.get).toHaveBeenCalledWith(MAESTRO_ENDPOINTS.INSTANCES.GET_BPMN(instanceId), {
        headers: expect.objectContaining({
          [FOLDER_KEY]: folderKey,
    ...
    it('should handle API errors', async () => {
      ...
      await expect(
        service.getBpmn(MAESTRO_TEST_CONSTANTS.INSTANCE_ID, MAESTRO_TEST_CONSTANTS.FOLDER_KEY),
      ).rejects.toThrow(TEST_CONSTANTS.ERROR_MESSAGE);
    });
  });
  ...
  describe('cancel', () => {
    ...
    it('should handle API errors', async () => {
      ...
      await expect(
        service.cancel(MAESTRO_TEST_CONSTANTS.INSTANCE_ID, MAESTRO_TEST_CONSTANTS.FOLDER_KEY),
      ).rejects.toThrow(TEST_CONSTANTS.ERROR_MESSAGE);
    });
  });
  ...
  describe('pause', () => {
    ...
    it('should handle API errors', async () => {
      ...
      await expect(
        service.pause(MAESTRO_TEST_CONSTANTS.INSTANCE_ID, MAESTRO_TEST_CONSTANTS.FOLDER_KEY),
      ).rejects.toThrow(TEST_CONSTANTS.ERROR_MESSAGE);
    });
  });
  ...
  describe('resume', () => {
    ...
    it('should handle API errors', async () => {
      ...
      await expect(
        service.resume(MAESTRO_TEST_CONSTANTS.INSTANCE_ID, MAESTRO_TEST_CONSTANTS.FOLDER_KEY),
      ).rejects.toThrow(TEST_CONSTANTS.ERROR_MESSAGE);
    });
  });
  ...
  describe('getVariables', () => {
    it('should return variables for process instance with BPMN metadata', async () => {
      ...
      expect(mockApiClient.get).toHaveBeenCalledWith(MAESTRO_ENDPOINTS.INSTANCES.GET_VARIABLES(instanceId), {
        headers: expect.objectContaining({
          [FOLDER_KEY]: folderKey,
        }),
        params: undefined,
    ...
    it('should handle API errors', async () => {
      ...
      await expect(
        service.getVariables(MAESTRO_TEST_CONSTANTS.INSTANCE_ID, MAESTRO_TEST_CONSTANTS.FOLDER_KEY),
      ).rejects.toThrow(TEST_CONSTANTS.ERROR_MESSAGE);
    });
  });
});
