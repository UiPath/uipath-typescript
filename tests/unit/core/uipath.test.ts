...
describe('UiPath Core', () => {
  ...
  describe('Configuration Access', () => {
    ...
    it('should return UiPathConfig instance from getConfig()', () => {
      const uiPath = new UiPath({
        baseUrl: TEST_CONSTANTS.BASE_URL,
        orgName: TEST_CONSTANTS.ORGANIZATION_ID,
        tenantName: TEST_CONSTANTS.TENANT_ID,
  ...
  describe('Context Access', () => {
    ...
    it('should provide consistent context across calls', () => {
      ...
      const context1 = uiPath.getContext();
      const context2 = uiPath.getContext();
  ...
  describe('Token Manager Access', () => {
    it('should expose getTokenManager() method', () => {
      const uiPath = new UiPath({
        baseUrl: TEST_CONSTANTS.BASE_URL,
        orgName: TEST_CONSTANTS.ORGANIZATION_ID,
        tenantName: TEST_CONSTANTS.TENANT_ID,
    ...
    it('should provide consistent token manager across calls', () => {
      const uiPath = new UiPath({
        baseUrl: TEST_CONSTANTS.BASE_URL,
        orgName: TEST_CONSTANTS.ORGANIZATION_ID,
        tenantName: TEST_CONSTANTS.TENANT_ID,
      ...
      const tokenManager1 = uiPath.getTokenManager();
      const tokenManager2 = uiPath.getTokenManager();
  ...
  describe('Dependency Injection Pattern', () => {
    it('should provide all necessary methods for service injection', () => {
      const uiPath = new UiPath({
        baseUrl: TEST_CONSTANTS.BASE_URL,
        orgName: TEST_CONSTANTS.ORGANIZATION_ID,
        tenantName: TEST_CONSTANTS.TENANT_ID,
      ...
      // Services need these methods via dependency injection
      expect(uiPath.getConfig).toBeDefined();
      expect(uiPath.getContext).toBeDefined();
      expect(uiPath.getTokenManager).toBeDefined();
    ...
    it('should allow services to access configuration', () => {
      const uiPath = new UiPath({
        baseUrl: TEST_CONSTANTS.BASE_URL,
        orgName: TEST_CONSTANTS.ORGANIZATION_ID,
        tenantName: TEST_CONSTANTS.TENANT_ID,
  ...
  describe('Multiple Instance Support', () => {
    it('should support creating multiple independent instances', () => {
      ...
      expect(uiPath1.getConfig().orgName).toBe('org1');
      expect(uiPath2.getConfig().orgName).toBe('org2');
      expect(uiPath1.getContext()).not.toBe(uiPath2.getContext());
    });
  });
});
